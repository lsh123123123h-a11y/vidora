...
2. 在设置中心完成模型供应商配置（文本/图像/视频模型）。接入 OpenAI 兼容中转站时，点击“添加供应商”并选择“兼容中转站”，填写供应商名称、Base URL 和 API Key，拉取 `/models` 后选择需要的模型并指定文本、图像或视频用途。
...
3. **启动 Web 服务**
   ...
   > 服务会在 `http://localhost:10588` 提供内置网页和 API。开发完成后可使用生产模式启动：
...
| 仓库             | 说明                               | GitHub                                             | Gitee                                            |
| ---------------- | ---------------------------------- | -------------------------------------------------- | ------------------------------------------------ |
| **Toonflow-app** | Web 服务（本仓库，推荐普通用户） | [GitHub](https://github.com/HBAI-Ltd/Toonflow-app) | [Gitee](https://gitee.com/HBAI-Ltd/Toonflow-app) |
| **Toonflow-web** | 前端源代码（适合前端开发者）       | [GitHub](https://github.com/HBAI-Ltd/Toonflow-web) | [Gitee](https://gitee.com/HBAI-Ltd/Toonflow-web) |

> 💡 **提示**：如果您只是想使用 Toonflow，安装依赖后启动本仓库的 Web 服务即可。前端仓库仅供需要二次开发或定制前端界面的开发者使用。
